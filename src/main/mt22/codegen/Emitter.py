...
class Emitter:
    ...
    *   @param toLabel the ending label  of the scope where the variable is active.
    ...
    def emitREADVAR(self, name, inType, index, frame):
        ...
        if type(inType) is IntegerType:
            ...
            type(inType) is ArrayType
            or type(inType) is ClassType
    ...
    *   @param isFinal true in case of constant; false otherwise
    ...
    def emitATTRIBUTE(self, lexeme, inType, isFinal, value=None):
        ...
        return self.jvm.emitSTATICFIELD(lexeme, self.getJVMType(inType), isFinal)
    ...
    *   @param isStatic <code>true</code> if the method is static; <code>false</code> otherwise.
    ...
    def emitMETHOD(self, lexeme, inType, isStatic):
        # lexeme: String
        # inType: Type
        # isStatic: Boolean

        return self.jvm.emitMETHOD(lexeme, self.getJVMType(inType), isStatic)
